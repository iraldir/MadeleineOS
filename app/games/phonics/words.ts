...
export const HARD: PhonicsWord[] = [
  ...
  { word: "Moana", match: ["moana", "moanna", "mowana"], imagePrompt: "a brave Polynesian island girl with long wavy dark hair and a red and orange skirt, holding a wooden oar, cute kids illustration, bright colors, white background", difficulty: "hard" },
  { word: "Ariel", match: ["ariel", "arielle", "aerial"], imagePrompt: "a cheerful young mermaid with long red hair and a green fish tail, cute kids illustration, bright colors, white background", difficulty: "hard" },
  { word: "Rapunzel", match: ["rapunzel", "repunzel", "rapunsel"], imagePrompt: "a smiling princess in a purple dress with extremely long golden braided hair coiling around her, cute kids illustration, bright colors, white background", difficulty: "hard" },
  { word: "Cinderella", match: ["cinderella", "cinderela", "sinderella"], imagePrompt: "a princess in a pale blue ball gown holding a sparkling glass slipper, cute kids illustration, bright colors, white background", difficulty: "hard" },
  { word: "Woody", match: ["woody", "woodie", "wudy"], imagePrompt: "a friendly cowboy rag doll toy in a yellow plaid shirt, blue jeans and a brown cowboy hat, cute kids illustration, bright colors, white background", difficulty: "hard" },
  { word: "Buzz", match: ["buzz", "buzz lightyear", "bus"], imagePrompt: "a cheerful toy astronaut figure in a silver and blue spacesuit with a round glass helmet, cute kids illustration, bright colors, white background", difficulty: "hard" },
